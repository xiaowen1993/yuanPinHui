...
public class DatesUtil {
	public static void main(String[] args) throws ParseException {
		System.out.println(DatesUtil.getFormerlyDate());
		System.out.println(DatesUtil.getDayEnd().getTime());
//		System.out.println(getEndDayOfMonth());
//
//		String date="2020-08-06";
//		SimpleDateFormat simpleDateFormat=new SimpleDateFormat("yyyy-MM-dd");
//		Date date1 = simpleDateFormat.parse(date);
//		System.out.println(DatesUtil.getDayStartTime(date1).getTime());
//		System.out.println(DatesUtil.getDayEndTime(date1).getTime());
	}


	//获取过去一个月天的时间
	public static long getFormerlyDate(){
		...
		Date m = c.getTime();
		long time = getDayStartTime(m).getTime();
		return time;
	}
